...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    // Check input errors before inserting in database
        ...
        // Prepare an insert statement
            $stmt = $link->prepare("INSERT INTO users (Name,Phone_Number,Email,medicine,Message) VALUES (?, ?, ?, ?, ?)");
            $stmt->bind_param("sssss", $param_Name, $param_Phone_Number, $param_Eamil, $param_medicine, $param_Message);
...
<html>
  ...
  <body>
            ...
            <div class="carousel-item active">
              <div class="container">
                <div class="row">
                  <div class="col-md-4">
                    <div class="img-box">
                      <img src="images/slider13.png" alt="" />
                    </div>
                  </div>
                  <div class="col-md-8">
                    <div class="detail-box">
                      <h1>
                        <br />
                        <span> "कर्म करो, फल की चिंता मत करो" </span>
                      </h1>
                      <h3>
                        Share your medicine, change a life. Join our mission to
                        provide healthcare for all.
                      </h3>
                      <div>
                        <a href="medicine.html"> Donate Now </a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="container">
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <div class="detail-box">
                      <h1>
                        <span>Donate medicine, show you care. </span>
                        <br />
                        <span> </span>
                      </h1>
                      <p>
                        We offer a seamless donation process, including pick-up
                        or drop-off options, and ensure that all donations are
                        screened, sorted, and distributed in a safe and
                        efficient manner.
                      </p>
                      <div>
                        <a href=""> Available </a>
              ...
              <div class="container">
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <div class="detail-box">
                      <h1>
                        We provide all types of medicines <br />
      ...
      <div class="container">
        <div class="feature_container">
          <div class="box">
            ...
            <div class="detail-box">
              <h5>Ease of Donation</h5>
              <p>
                Just enter a few details and get your medicines picked up by our
                agents
              </p>
            </div>
          </div>
          <div class="box">
            ...
            <div class="detail-box">
              <h5>Direct Contact with NGOs</h5>
              <p>Connect instantly with government affiliated NGOs.</p>
            </div>
          </div>
          <div class="box">
            <div class="img-box">
            ...
            <div class="detail-box">
              <h5>support24/7</h5>
              <p>
                Connect with our Agents and they will assist you step by step
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-3 col-md-5 offset-md-2">
            <div class="detail-box">
              <h2>
                Medicine is a <span>RIGHT</span>, not a <span> PRIVILEGE</span>.
              </h2>
              <br />
              <h3>Your small donation can bring a big change</h3>
              <div>
                <a href=""> Donate Now </a>
              </div>
            </div>
    ...
    <section class="health_section layout_padding">
      ...
      <div class="health_carousel-container">
        <h2 class="text-uppercase">Vitamins & Supplements</h2>
        <div class="carousel-wrap layout_padding2">
          ...
          <div class="col-md-5">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
              ...
              <div class="form-group ">
                ...
                <input type="text" class="form-control" id="exampleInputNumber1" Name="medicine">
              </div>
              <div class="form-group">
